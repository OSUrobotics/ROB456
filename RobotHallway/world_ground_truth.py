...
# You do not need to edit anything in this class, but you will need to use it 
class WorldGroundTruth:
    ...
    def random_door_placement(self, n_doors:int = 3, n_bins:int = 20):
    ...
    def _location_in_front_of_door(self):
        """Return a location in front of the first door (testing routine)"""
        return self.doors[0]

    def _location_not_in_front_of_door(self):
    ...
    def is_location_in_front_of_door(self, location):
        """ GUIDE: Use this routine in Bayes & particle filter to determine if a specific location is in front of the door
